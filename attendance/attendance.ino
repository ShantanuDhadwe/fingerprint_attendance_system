...
#define records 25  // 10 for 10 user
...
void setup() {
  ...
  if (rtc.lostPower()) {
    ...
    rtc.adjust(DateTime(2023, 7, 4, 15, 14, 0));
    // This line sets the RTC with an explicit date & time, for example to set
    // June 7, 2018 at 11am you would call:
    // rtc.adjust(DateTime(2018, 6, 8, 11, 0, 0));
  }
  lcd.setCursor(0, 0);
...
void loop() {
  ...
  if (result > 0) {
    ...
    lcd.clear();
    lcd.print("ID:");
    char *ownerNames[17] = { "suyash", "suyash", "vaishnavi", "riddhim", "shantanu", "siddhant", "aarushi", "gauri", "tushar", "nisarg", "manish", "dhananjay", "sanket", "amit", "kedar", "bhavesh", "namrata" /* Add other names here, separated by commas */ };
    lcd.print(ownerNames[result - 1]);
    lcd.setCursor(0, 1);
    lcd.print("Please Wait....");
    delay(1000);
    attendance(result);
    ...
    Serial.println(name);
    // Serial.print(ownerNames[result-1]);
    Serial.print("  ");
    Serial.println();
    delay(1000);
    digitalWrite(indFinger, HIGH);
